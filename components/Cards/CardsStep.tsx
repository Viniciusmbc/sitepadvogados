  ...
  return (
    ...
    >
      <motion.div
        ...
        className=" w-72 h-60 px-5 py-2 text-center border border-quaternary shadow-xl relative "
      >
      ...
      <motion.div
        ...
        animate={control}
        variants={boxVariant}
        transition={{ delay: 2.5, ease: "easeOut", duration: 1 }}
        className=" w-72 h-60 px-8 py-6 text-center border border-quaternary shadow-xl relative "
      >
        <div className=" h-10 bg-quaternary border-b-primary  shadow-md absolute inset-x-0 top-0">
          <div className=" flex gap-x-4 justify-end  h-10 items-center mr-2 ">
      ...
      <motion.div
        ...
        animate={control}
        variants={boxVariant}
        transition={{ delay: 3.5, ease: "easeOut", duration: 1 }}
        className=" w-72 h-60 px-8 py-6 text-center border border-quaternary shadow-xl relative "
      >
        <div className="h-10 bg-quaternary border-b-primary  shadow-md absolute inset-x-0 top-0">
          <div className=" flex gap-x-4 justify-end  h-10 items-center mr-2 ">
